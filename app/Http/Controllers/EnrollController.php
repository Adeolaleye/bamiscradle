...
class EnrollController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $image = Image::make($request['pickup_picture_1'])->resize(100, 100);
        $image->save('pictures/'.$pickup_picture_1);
        }
        if(request()->has('pickup_picture_2')){
        $pickup_picture_2 = time() . '-' .$request['pickup_picture_1']->getClientOriginalName();
        $image = Image::make($request['pickup_picture_2'])->resize(100, 100);
        ...
        $pickup = Pickup::create([
            ...
            'pickup_picture_2' => isset($pickup_picture_2) ? 'pictures/'.$pickup_picture_2: 'N/A',
        ]);
